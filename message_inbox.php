...
$_SESSION["active_sub_messaging_inbox"] = "active-sub-menu";
...
<html>
	<head>
		...
		<script type="text/javascript" language="javascript">
			$(document).ready(function() {
				...
				<?php
					// success in updating
					if (isset($_SESSION["success_reply_message"])){
						echo '$(document).ready(function() {
							$("#success_modal_body").html("'.$_SESSION["success_reply_message"].'");
							$("#successModal").modal("show");
						});';
						$_SESSION["success_reply_message"] = null;
					}
	...
	<body>
			...
			<div class="container-fluid">
				<div class="row" style="border-bottom:1px solid #BDBDBD;">
					<ol class="breadcrumb">
						...
						<li class="active" id="home_id">Inbox</li> 
					</ol>
				</div>
			</div>
					...
					<div class="col-sm-12 content-div">
						<div class="thumbnail" style="border:1px solid #BDBDBD;">
							<div class="caption">
								...
								<fieldset>
									<legend style="border-bottom:1px solid #BDBDBD;"><span class="glyphicon glyphicon-list-alt" style="color:#2E86C1;"></span> MESSAGE INBOX</legend>
									<table id="inbox_list" class="table table-bordered table-hover table-striped" style="border:1px solid #BDBDBD;">
										<thead>
											<tr>
												<th><span class="glyphicon glyphicon-calendar" style="color:#186a3b"></span> Date</th>
												<th><span class="glyphicon glyphicon-user" style="color:#186a3b"></span> From</th>
												<th><span class="glyphicon glyphicon-user" style="color:#186a3b"></span> To</th>
												<th><span class="glyphicon glyphicon-credit-card" style="color:#186a3b"></span> Subject</th>
												<th class="no-sort"><span class="glyphicon glyphicon-envelope" style="color:#186a3b"></span> Message</th>
												<th><span class="glyphicon glyphicon-wrench" style="color:#186a3b"></span> Action</th>
											</tr>
										</thead>
										<tbody>	
											<?php
												$message_class->getAllMessageToTable($id);
		...
		<!-- FOR READ MESSAGE MODAL MODAL -->
		<div id="readMessageModal" class="modal fade" role="dialog" tabindex="-1">
			<div class="modal-dialog modal-lg">
			<!-- Modal content-->
				<div class="modal-content">
					<div class="modal-header" style="background-color:#357ca5;">
						<button type="button" class="close" data-dismiss="modal">&times;</button>
						<h5 class="modal-title" style="color:#fff"><span class='glyphicon glyphicon-envelope' style='color:#b7950b'></span> Message History</h5>
					</div> 
					<div class="modal-body" id="read_modal_body" style="">
			...
			<!-- Modal content-->
				<div class="modal-content">
					<div class="modal-header" style="background-color:#1d8348;">
						<button type="button" class="close" data-dismiss="modal">&times;</button>
						<h5 class="modal-title" style="color:#fff"><span class='glyphicon glyphicon-check' style='color:#fff'></span>&nbsp;Reply Notification</h5>
					</div> 
