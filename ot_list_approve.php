...
$_SESSION["active_sub_ot_list"] = "active-sub-menu";
...
<?php
	...
	if ($emp_info->alreadyHead($id) == 0 && $role != 1 && $role != 2 && $role != 3) {
...
<html>
	<head>
		<title>Overtime List - Approved</title>
		...
		<script>
			$(document).ready(function(){
				$('#ot_approve_list').DataTable();
				
				// over_all_ot_approve_list
				$('#over_all_ot_approve_list').DataTable();
			...
			<div class="container-fluid">
				<div class="row">
					<?php
						...
						if ($_SESSION["role"] == 2 || $emp_info->alreadyHead($id) != 0){
							...
							<div class="caption">
								...
								<fieldset>
									...
									<!--<div class="col-sm-10 col-sm-offset-1"> -->
										<table id="ot_approve_list" class="table table-bordered table-hover table-striped" style="border:1px solid #BDBDBD;">
											<thead>
												<tr>
													...
													<th class="no-sort"><span class="glyphicon glyphicon-time" style="color:#186a3b"></span> Time From</th>
													...
													<th  class="no-sort"><span class="glyphicon glyphicon-hourglass" style="color:#186a3b"></span> Type of OT</th>
												</tr>
											</thead>
											<tbody>	
											<?php
												$attendance_ot_class = new Attendance_Overtime;
												//$user_id = $_SESSION["id"];
												$attendance_ot_class->getAllApproveOTListCurrentCutOff($role,$id);
					...
					<div class="col-sm-12 content-div">
						<div class="thumbnail" style="border:1px solid #BDBDBD;">
							<div class="caption">
								...
								<fieldset>
									<legend style="color:#357ca5;border-bottom:1px solid #BDBDBD"><span class="glyphicon glyphicon-list-alt"></span> All Overtime Approve List - cut off: 
										<?php
											$cut_off_class = new CutOff;
											$cut_off_class->getCutOffPeriod();
									...
									<!-- <span><small><b><span class="glyphicon glyphicon-info-sign" style="color:#2E86C1;"></span> Note: If the position already used for creating an employee it can not be edit and delete.</b></small></span><br/><br/> -->
									<!--<div class="col-sm-10 col-sm-offset-1"> -->
										<table id="over_all_ot_approve_list" class="table table-bordered table-hover table-striped" style="border:1px solid #BDBDBD;">
											<thead>
												<tr>
													<th class="no-sort"><span class="glyphicon glyphicon-calendar" style="color:#186a3b"></span> Employee Name</th>
													<th class="no-sort"><span class="glyphicon glyphicon-calendar" style="color:#186a3b"></span> Date</th>
											...
											<?php
												$attendance_ot_class = new Attendance_Overtime;
												//$user_id = $_SESSION["id"];
												$attendance_ot_class->getAllApproveOTListOverAllCurrentCutOff();


											?>
											</tbody>
										</table>
										<div class="pull-right" id="print_ot_history_reports" style="cursor:pointer;">
								 			<span class="glyphicon glyphicon-print" style="color: #2c3e50"></span> <b style="color:#158cba">Print OT History Reports</b>
								 		</div>

								 		<div class="pull-right" id="print_ot_cut_off_reports" style="cursor:pointer;margin-right:10px;">
								 			<span class="glyphicon glyphicon-print" style="color: #2c3e50"></span> <b style="color:#158cba">Print Cut Off Approve OT List</b>
								 		</div>
									<!--</div> -->
								</fieldset>
							</div>
