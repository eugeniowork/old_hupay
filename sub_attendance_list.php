...
$_SESSION["active_sub_attendance_list"] = "active-sub-menu";
...
<html>
	<head>
		<title>Subordinate Attendace List</title>
		...
		<script>
			$(document).ready(function(){
		      ...
		      $("input[id='searchAllSubAttendance']").on("click",function () {
		          ...
		          */
		             ...
		             // $("#attendance_table").html("<div class='col-sm-12' style='margin-top:50px;border:1px solid #BDBDBD;'><div id='unfields_info' class=''><center><div class=loader></div>Loading Information ...</center></div></div>"); // just commenting but if will live it will be comment out
		              ...
		              $.ajax({
		                  type: "POST",
		                  url: "ajax/append_search_all_subordinate_attendance.php",
		                  data: datastring,
		                  cache: false,
		                 // datatype: "php",
			...
			<div class="container-fluid">
				<div class="row" style="border-bottom:1px solid #BDBDBD;">
					<ol class="breadcrumb">
						...
						<li class="active" id="home_id">View Subordinate All Attendance List</li> 
					</ol>
				</div>
			</div>
								...
								<fieldset>
									...
									<div class="col-sm-12" style="background-color: #f2f4f4 ;padding:5px 5px 10px 5px;"> 
										...
										<form>
											...
											<div class="col-sm-3">
												<input type="button" class="btn btn-primary btn-sm" value="Search" id="searchAllSubAttendance"/>
											</div>
										</form>
