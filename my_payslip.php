...
$_SESSION["active_sub_my_payslip"] = "active-sub-menu";
$_SESSION["active_my_payslip"] = "background-color:#1d8348";
			...
			<div class="container-fluid">
				<div class="row" style="border-bottom:1px solid #BDBDBD;">
					<ol class="breadcrumb">
						...
						<li class="active" id="home_id">My Payslip</li> 
					</ol>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-sm-12 content-div">
						<div class="thumbnail" style="border:1px solid #BDBDBD;">
							<div class="caption">
								<fieldset>
									<legend style="color:#357ca5;border-bottom:1px solid #BDBDBD"><span class="glyphicon glyphicon-list-alt"></span> Payslip List</legend>
									<div class="col-sm-8 col-sm-offset-2">
										
										<table id="payslip_list" class="table table-bordered table-hover table-striped" style="border:1px solid #BDBDBD;">
											<thead>
												<tr>
													<th class="no-sort"><span class="glyphicon glyphicon-calendar" style="color:#186a3b"></span> Cut Off Period</th>
											...
											<tbody>	
												<?php
													...
													$payroll_class->payrollInfoToTable($id);
												?>
											</tbody>
										</table>
									</div>
