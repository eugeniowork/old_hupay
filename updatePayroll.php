...
<html>
	<head>
		<title>Update Payroll Info</title>
			...
			<div class="container-fluid">
				<div class="row" style="border-bottom:1px solid #BDBDBD;">
					<ol class="breadcrumb">
						...
						<li class="active" id="home_id">Update Payroll Info</li> 
					</ol>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="panel panel-primary" style="margin-top:10px;"> <!-- content-element -->
							...
							<div class="custom-panel-heading" style="color:#317eac;"><center><span class="glyphicon glyphicon-list-alt"></span> Payroll List Information of Employee for the - <?php $cut_off_class->getCutOffPeriod(); ?></center></div> 
							<br/>
							 ...
							 <div class="panel-body">
							 	<div class="col-sm-6 col-sm-offset-3">
							 		<table id="emp_list_with_pag_ibig_loan" class="table table-bordered table-hover table-striped" style="border:1px solid #BDBDBD;">
										<thead>
											<tr> 	
												<th><center><span class="glyphicon glyphicon-user" style="color:#186a3b"></span> Employee Name</center></th>
											</tr>
										</thead>
										<tbody>	
										<?php
											$cutOffPeriod = $cut_off_class->getCutOffPeriodLatest();
											$payroll_class->getAllEmployeeToUpdatePayrollInfo($cutOffPeriod);
							...
							<i><strong>&nbsp;Note: You can update payroll information if the ADMIN EXECUTIVE not yet approve the submitted payroll info</strong></i>
							<br/>&nbsp;
						</div>
					</div>
