...
$_SESSION["active_year_total_deduction"] = "background-color:#1d8348";
...
<html>
	<head>
		<title>Year Total Deduction</title>
		...
		<script>
			$(document).ready(function(){
				...
				<?php
					...
					// for updating error
					if (isset($_SESSION["update_ytd_error"])){
						echo '$(document).ready(function() {
							$("#error_modal_body").html("'.$_SESSION["update_ytd_error"].'");
							$("#errorModal").modal("show");
						});';
						$_SESSION["update_ytd_error"] = null;
					}


					// for success updating
					if (isset($_SESSION["update_ytd_success"])){
						echo '$(document).ready(function() {
							$("#success_modal_body_add").html("'.$_SESSION["update_ytd_success"].'");
							$("#add_successModal").modal("show");
						});';
						$_SESSION["update_ytd_success"] = null;
					}
			...
			<div class="container-fluid">
				<div class="row" style="border-bottom:1px solid #BDBDBD;">
					<ol class="breadcrumb">
						...
						<li class="active" id="home_id">Year Total Deduction</li> 
					</ol>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="panel panel-primary" style="margin-top:10px;"> <!-- content-element -->
							...
							<div class="custom-panel-heading" style="color:#317eac;"><center><span class="glyphicon glyphicon-list-alt"></span> List of Employee With Year Total Deduction For the Year of <?php echo date("Y"); ?></center></div> 
							 		...
							 		<table id="emp_list_with_pag_ibig_loan" class="table table-bordered table-hover table-striped" style="border:1px solid #BDBDBD;">
										<thead>
											<tr> 	
												...
												<th><span class="glyphicon glyphicon-calendar" style="color:#186a3b"></span> YTD GROSS</th>
												<th><span class="glyphicon glyphicon-shopping-cart" style="color:#186a3b"></span> YTD Allowance</th>
												<th><span class="glyphicon glyphicon-ruble" style="color:#186a3b"></span> YTD W/ TAX</th>
		...
		<div id="updateFormModal" class="modal fade" role="dialog" tabindex="-1">
			...
			<!-- Modal content-->
				<div class="modal-content">
					...
					<div class="modal-body" id="update_ytdForm_body">
