...
$_SESSION["active_sub_sss"] = "active-sub-menu";
...
<html>
	<head>
		<title>SSS Contribution Table</title>
		...
		<script>
			$(document).ready(function(){
				...
				<?php
					// error in adding
					if (isset($_SESSION["error_msg_sss_contrib"])){
						echo '$(document).ready(function() {
							$("#add_error_modal_body").html("'.$_SESSION["error_msg_sss_contrib"].'");
							$("#add_errorModal").modal("show");
						});';
						$_SESSION["error_msg_sss_contrib"] = null;
					}


					// success in adding
					if (isset($_SESSION["success_msg_sss_contrib"])){
						echo '$(document).ready(function() {
							$("#success_modal_body_add").html("'.$_SESSION["success_msg_sss_contrib"].'");
							$("#add_successModal").modal("show");
						});';
						$_SESSION["success_msg_sss_contrib"] = null;
					}
					...
					if (isset($_SESSION["error_update_msg_sss_contrib"])){
							echo '$(document).ready(function() {
								$("#error_msg_update").html("'.$_SESSION["error_update_msg_sss_contrib"].'");
								$("#update_errorModal").modal("show");
							});';
							$_SESSION["error_update_msg_sss_contrib"] = null;
					}


					// for success in updating 
					if (isset($_SESSION["success_msg__update_sss_contrib"])){
							echo '$(document).ready(function() {
								$("#success_modal_body_update").html("'.$_SESSION["success_msg__update_sss_contrib"].'");
								$("#update_successModal").modal("show");
							});';
							$_SESSION["success_msg__update_sss_contrib"] = null;
						}
					?>
	...
	<body>
			...
			<div class="container-fluid">
				<div class="row" style="border-bottom:1px solid #BDBDBD;">
					<ol class="breadcrumb">
						...
						<li class="active" id="home_id">SSS Contribution Table</li> 
					</ol>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-sm-12 content-div">
						<div class="thumbnail" style="border:1px solid #BDBDBD;">
							<div class="caption">
								<fieldset>
									<legend style="color:#357ca5;border-bottom:1px solid #BDBDBD"><span class="glyphicon glyphicon-list-alt"></span> SSS Contribution Table 
										<?php 
											if ($_SESSION["role"] == 1){
										?>
									...
									<div class="col-sm-8 col-sm-offset-2">
										...
										<table id="sss_contribution_list" class="table table-bordered table-hover table-striped" style="border:1px solid #BDBDBD;">
											...
											<tbody>	
												<?php
													$sssContribution_class = new SSS_Contribution;
													$sssContribution_class->getContributionToTable();
			...
			<!-- Modal content-->
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="container-fluid">
							<form class="form-horizontal" action="php script/add_sssContribution.php" method="post">		
								<div class="col-sm-12">
									...
									<div class="form-group">
										...
										<input type="text" id="float_only" name="sssContribution" autocomplete="off" placeholder="Enter Contribution" class="form-control" required="required">									 													
									</div>
		...
		<div id="update_errorModal" class="modal fade" role="dialog" tabindex="-1">
			...
			<!-- Modal content-->
				<div class="modal-content">
					<div class="modal-header" style="background-color:#b03a2e;">
						<button type="button" class="close" data-dismiss="modal">&times;</button>
						<h5 class="modal-title" style="color:#fff"><span class='glyphicon glyphicon-warning-sign' style='color:#fff'></span>&nbsp;Update SSS Contribution Info</h5>
					</div> 
		...
		<div id="updateSSSContribModal" class="modal fade" role="dialog" tabindex="-1">
			<div class="modal-dialog modal-sm" id="modal_dialog_update_info">
			<!-- Modal content-->
				<div class="modal-content">
					<div class="modal-header" style="background-color:#158cba;">
						<button type="button" class="close" data-dismiss="modal">&times;</button>
						<h5 class="modal-title" style="color:#fff"><span class='glyphicon glyphicon-pencil' style='color:#fff'></span>&nbsp;Update SSS Contribution Info</h5>
					</div> 
		...
		<div id="delete_modal" class="modal fade" role="dialog" tabindex="-1">
			...
			<!-- Modal content-->
				<div class="modal-content">
					<div class="modal-header" style="background-color:#158cba;">
						<button type="button" class="close" data-dismiss="modal">&times;</button>
						<h5 class="modal-title" style="color:#fff"><span class='glyphicon glyphicon-trash' style='color:#fff'></span>&nbsp;Delete SSS Contribution Info</h5>
					</div> 
					<div class="modal-body" id="modal_body_delete" >
			 		...
			 		<div class="modal-footer" style="padding:5px;text-align:center;" id="delete_modal_footer">
						<a href="#" class="btn btn-default" id="yes_contribution">YES</a>
		...
		<div id="successDelete" class="modal fade" role="dialog" tabindex="-1">
			...
			<!-- Modal content-->
				<div class="modal-content">
					<div class="modal-header" style="background-color:#1d8348;">
						<button type="button" class="close" data-dismiss="modal">&times;</button>
						<h5 class="modal-title" style="color:#fff"><span class='glyphicon glyphicon-trash' style='color:#fff'></span>&nbsp;Delete SSS Contribution Notification</h5>
					</div> 
		...
		<div id="update_successModal" class="modal fade" role="dialog" tabindex="-1">
			...
			<!-- Modal content-->
				<div class="modal-content">
					<div class="modal-header" style="background-color:#1d8348;">
						<button type="button" class="close" data-dismiss="modal">&times;</button>
						<h5 class="modal-title" style="color:#fff"><span class='glyphicon glyphicon-pencil' style='color:#fff'></span>&nbsp;Update SSS Contribution</h5>
					</div> 
