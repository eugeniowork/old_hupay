			...
			<script>
				$(document).ready(function(){
			       ...
			       $("a[id='update_info']").on("click", function () {
			          if ($(this).html() == "Basic Information" || $(this).html() == "Company Information" || $(this).html() == "Government Information" || $(this).html() == "School Information" || $(this).html() == "Work Experience" || $(this).html() == "Account Information" || $(this).html() == "Add/ Update Dependant" || $(this).html() == "Add/ Update Allowance" || $(this).html() == "Leave Information") {
