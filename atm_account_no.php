...
$_SESSION["active_atm_no"] = "background-color:#1d8348";
			...
			<div class="container-fluid">
				<div class="row" style="border-bottom:1px solid #BDBDBD;">
					<ol class="breadcrumb">
						...
						<li class="active" id="home_id">ATM Account No. Information</li> 
					</ol>
				</div>
			</div>
					...
					<div class="col-sm-12 content-div">
						<div class="thumbnail" style="border:1px solid #BDBDBD;">
							<div class="caption">
								...
								<fieldset>
									<legend style="border-bottom:1px solid #BDBDBD;"><span class="glyphicon glyphicon-list-alt" style="color:#2E86C1;"></span> List of Employee With ATM (Account No. Information)</legend>
										
									<div class="pull-right" id="print_atm_reports" style="cursor:pointer;">
							 			<span class="glyphicon glyphicon-print" style="color: #2c3e50"></span> <b style="color:#158cba">Print ATM Account No Reports</b>
							 		</div>

							 		<br/>
							 		<br/>

									<table id="atm_account_no_list" class="table table-bordered table-hover table-striped" style="border:1px solid #BDBDBD;">
										<thead>
											<tr>
												<th><span class="glyphicon glyphicon-user" style="color:#186a3b"></span> Employee Name</th>
												<th><span class="glyphicon glyphicon-credit-card" style="color:#186a3b"></span> UB ATM Account No.</th>
										...
										<tbody>	
											<?php
												...
												$emp_info->getAtmAccountNoListToTable();
											?>
										</tbody>
									</table>
								</fieldset>
