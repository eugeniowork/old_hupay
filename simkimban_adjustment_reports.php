...
$_SESSION["active_sub_simkimban_adjustment"] = "active-sub-menu";
...
<html>
	<head>
		<title>SIMKIMBAN Adjustment Reports</title>
			...
			<div class="container-fluid">
				<div class="row" style="border-bottom:1px solid #BDBDBD;">
					<ol class="breadcrumb">
						...
						<li class="active" id="home_id">Adjusment SIMKIMBAN Reports</li> 
					</ol>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-sm-12 content-div">
						<div class="thumbnail" style="border:1px solid #BDBDBD;">
							<div class="caption">
								<fieldset>
									<legend style="color:#357ca5;border-bottom:1px solid #BDBDBD"><span class="glyphicon glyphicon-list-alt"></span> Adjustment SIMKIMBAN Reports List</legend>
									...
									<div class="col-sm-12">
										<table id="payroll_reports" class="table table-bordered table-hover table-striped" style="border:1px solid #BDBDBD;">
											...
											<?php
												 ...
												 $adjusment_loan_class->adjustmentSimkimbanReportListToTable();
