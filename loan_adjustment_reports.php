...
$_SESSION["active_sub_loan_adjustment"] = "active-sub-menu";
...
<html>
	<head>
		<title>Loan Adjustment Reports</title>
		...
		<div class="sidebar">
			<ul class="nav">
				<div style="text-align:center;padding:15px;background-color:#e9ecf2;">
					...
					<!--<div class="change-profile-div" title="Change Profile Picture">
				...
				<li class="parent">
					...
					<ul class="children collapse in" id="sub-item-1-adjustment-report">
						<li class="">
							<a class="active-sub-menu" href="loan_adjustment_reports.php">
			...
			<div class="container-fluid">
				<div class="row" style="border-bottom:1px solid #BDBDBD;">
					<ol class="breadcrumb">
						...
						<li class="active" id="home_id">Adjusment Salary Loan Reports</li> 
					</ol>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-sm-12 content-div">
						<div class="thumbnail" style="border:1px solid #BDBDBD;">
							<div class="caption">
								<fieldset>
									<legend style="color:#357ca5;border-bottom:1px solid #BDBDBD"><span class="glyphicon glyphicon-list-alt"></span> Adjustment Salary Loan Reports List</legend>
										...
										<table id="payroll_reports" class="table table-bordered table-hover table-striped" style="border:1px solid #BDBDBD;">
											<thead>
												<tr>
													...
													<th><span class="glyphicon glyphicon-calendar" style="color:#186a3b"></span> Date Payment</th>
													<th><span class="glyphicon glyphicon-edit" style="color:#186a3b"></span> Loan Type</th>
													<th><span class="glyphicon glyphicon-ruble" style="color:#186a3b"></span> Cash Payment</th>
													<th><span class="glyphicon glyphicon-ruble" style="color:#186a3b"></span> Outstanding Balance</th>
													<!--<th><span class="glyphicon glyphicon-tint" style="color:#186a3b"></span> Remarks</th> -->
											...
											<?php
												 ...
												 $adjusment_loan_class = new AdjustmentLoan;
												 $adjusment_loan_class->adjustmentReportListToTable();
