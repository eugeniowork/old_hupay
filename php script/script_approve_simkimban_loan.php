...
if (isset($_POST["simkimban_id"])){
	...
	$simkimban_class->approveSimkimbanLoan($simkimban_id,date("Y-m-d") ,$_SESSION["id"]);
	...
	$_SESSION["add_simkimban_success"] = "<center><span class='glyphicon glyphicon-ok'  style='color:#196F3D'></span> You successfully approve file a simkimban loan of <b>$empName</b>  for <b>$totalMonths months</b> starting from <b>$new_dateFrom - $new_dateTo</b> amounting of <b>Php $new_amountLoan $deductionType</b>.</center>";
