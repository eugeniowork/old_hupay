...
if (isset($_POST["empName"]) && isset($_POST["deductionType"]) && isset($_POST["totalMonths"]) && isset($_POST["dateTo"]) 
	...
	$emp_class = new EmployeeInformation;
	...
	//$emp_id = $emp_class->getEmpIdByEmployeeName($empName);
	$emp_id = $_POST["empId"];
	...
	// success so add
		...
		$simkimban_class->insertSimkimbanManual($emp_id,$deductionType,$deductionDay,$totalMonths,$dateFrom,$dateTo,$item,$amountLoan,$deduction,$remainingBalance,1,$dateCreated);
		...
		$_SESSION["add_simkimban_success"] = "<center><span class='glyphicon glyphicon-ok' style='color:#1d8348'></span> <b>Employee $empName</b> is successfully file a <b>Simkimban Loan</b></center>";
