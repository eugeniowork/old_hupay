...
$_SESSION["active_department"] = "background-color:#1d8348";
				...
				<div class="row">
					<div class="col-sm-12 content-div">
						<div class="thumbnail" style="border:1px solid #BDBDBD;">
							<div class="caption">
								<fieldset>
									<legend style="color:#357ca5;border-bottom:1px solid #BDBDBD"><span class="glyphicon glyphicon-list-alt"></span> Department List 
										<?php
											if ($_SESSION["role"] == 1){
										?>	
										<small class="pull-right">
											<a href="#add_dept_modal" data-toggle="modal" class="custom-add-items"><span class="glyphicon glyphicon-plus"></span>Add New</a>
										</small>
										<?php
											}
										?>
								...
								<div class="col-sm-12">
									<div class="form-group">
										...
										<div class="input-group">
											<input type="text" name="department" id="department_txt" autocomplete="off" placeholder="Enter Department" class="form-control" required="required">
