...
<form class="" action="" method="post" id="form_deleteSalaryLoan">
	<div class="container-fluid">
		<div style="text-align:center;">					
			<span><span class="glyphicon glyphicon-warning-sign" style="color:#CB4335;"></span> Are you sure you want to <b>accept</b> your <b>File Salary Loan</b> with the amount of <b>Php <?php echo $amountLoan; ?></b> for <b> <?php echo $row->totalMonths; ?> months</b> starting <b><?php echo $dateFrom; ?></b> to <b><?php echo $dateTo; ?></b>?</span>
		</div>						
	</div>
</form>