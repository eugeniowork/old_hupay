...
if (isset($_POST["philhealth_contrib_id"])) {
	...
	// if success
		...
		$_SESSION["update_philhealth_contribution"] = $philhealth_contrib_id;

	
?>
	<div class="container-fluid">
		<!-- <form class="form-horizontal" action="php script/update_sss_contribution.php" method="post"> -->
		<form class="form-horizontal" action="php script/update_philhealth_contribution.php" method="post">		
			<div class="col-sm-12">

				<?php

					if ($philhealth_contrib_class->existOver() == 0 || $row->compensationTo == "0"){
				?>
	...
	<script>
		$(document).ready(function(){
		    ...
		    // sssContribution
		    $("input[name='Contribution']").on('input', function(){
		       if ($(this).attr("maxlength") != 9){
		            if ($(this).val().length > 9){
		                $(this).val($(this).val().slice(0,-1));
		            }
