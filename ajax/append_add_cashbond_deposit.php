...
?>
			...
			<div class="row">
				<form class="form-horizontal" method="post" action="" id="form_adjustCashbond">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" id="float_only" name="deposit" value="" class="form-control" placeholder="Deposit ..." required="required"/>
						</div>
					</div>
					...
					<div class="form-group" style="text-align:center;">
						<input type="submit" value="Deposit" class="btn btn-success btn-sm" id="deposit_cashbond"/>
					</div>
		...
		<script>
			$(document).ready(function(){
				...
				// for update button
				$("input[id='deposit_cashbond']").on("click",function () {
					if ($("input[name='deposit']").val() == "" && $("textarea[name='remarks']").val() == ""){					
						...
						$("#form_adjustCashbond").attr("action","php script/add_deposit_cashbond.php");
