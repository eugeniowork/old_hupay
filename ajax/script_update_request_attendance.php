...
if(isset($_POST["attendance_notif_id"]) && isset($_POST["approve"])) {
				            	...
				            	if (data == "<center><span class='glyphicon glyphicon-remove' style='color:#CB4335'></span> You have entered an invalid password.</center>"){
				             	...
				             	// if success
				             		...
				             		// if equal to approve
					             		...
					             		$("#approve_update_attendance_form").attr("action","php script/update_request_attendance_approve.php?attendance_notif_id=<?php echo $attendance_notif_id; ?>&approve=<?php echo $approve; ?>")
