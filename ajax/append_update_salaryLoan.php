...
?>
		...
		<form class="form-horizontal" action="" id="form_updateSalaryLoan" method="post">
			...
			<div class="form-group">
				<label class="control-label col-sm-3 col-sm-offset-1">Remarks:</label>
				<div class="col-sm-6 txt-pagibig-loan">
					<textarea class="form-control" required="required" name="remarks"><?php echo $row->remarks; ?></textarea>
				</div>
			</div>

			<div class="form-group">
				<div class="col-sm-offset-6">
					<input type="submit" value="Update" id="updateSalaryLoan" class="btn btn-primary btn-sm"/>
				</div>
			</div>
