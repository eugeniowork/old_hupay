...
if (isset($_POST["pagibig_contrib_id"])) {
	...
	// if success
		...
		$_SESSION["update_pagibig_contribution"] = $pagibig_contrib_id;

	
?>
	<div class="container-fluid">
		<!-- <form class="form-horizontal" action="php script/update_sss_contribution.php" method="post"> -->
		<form class="form-horizontal" action="php script/update_pagibig_contribution.php" method="post">		
			<div class="col-sm-12">

				<?php

					if ($pagibig_contrib_class->existOver() == 0 || $row->compensationTo == "0"){
				?>
