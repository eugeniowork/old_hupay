				            	...
				            	if (data == "<center><span class='glyphicon glyphicon-remove' style='color:#CB4335'></span> You have entered an invalid password.</center>"){
				             	...
				             	// if success
				             		...
				             		// if equal to approve
					             		...
					             		$("#approve_update_attendance_form").attr("action","php script/approve_payroll_script.php?approve_payroll_id=<?php echo $approve_payroll_id; ?>&approve=<?php echo $approve; ?>")
