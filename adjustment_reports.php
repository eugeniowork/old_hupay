...
$_SESSION["active_sub_payroll_adjust"] = "active-sub-menu";
...
<html>
	<head>
		<title>Adjustment Reports</title>
			...
			<div class="container-fluid">
				<div class="row" style="border-bottom:1px solid #BDBDBD;">
					<ol class="breadcrumb">
						...
						<li class="active" id="home_id">Adjustment Reports</li> 
					</ol>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-sm-12 content-div">
						<div class="thumbnail" style="border:1px solid #BDBDBD;">
							<div class="caption">
								<fieldset>
									<legend style="color:#357ca5;border-bottom:1px solid #BDBDBD"><span class="glyphicon glyphicon-list-alt"></span> Adjustment Reports List</legend>
									...
									<div class="col-sm-8 col-sm-offset-2">
										<table id="payroll_reports" class="table table-bordered table-hover table-striped" style="border:1px solid #BDBDBD;">
											...
											<?php
												...
												$payroll_class->adjustmentReportToTable();
